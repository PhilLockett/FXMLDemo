...
/*
 * TextFieldCommand is a class that captures the setShowGuide Command.
 */
...
public class TextFieldCommand implements Command {
    ...
    private final String className = "TextFieldCommand";
    private final String originalValue;
    private String newValue;

    public TextFieldCommand(String value) {
        originalValue = Model.getInstance().getMyText();
        newValue = value;
    }

    @Override
    public void execute() {
        Model.getInstance().setMyText(newValue);
    }
    ...
    public boolean update(Command newCommand) {
        ...
        TextFieldCommand command = (TextFieldCommand)newCommand;
