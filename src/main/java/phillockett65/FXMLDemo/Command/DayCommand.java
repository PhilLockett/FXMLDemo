...
/*
 * DayCommand is a class that captures the setShowGuide Command.
 */
...
public class DayCommand implements Command {
    ...
    private final String className = "DayCommand";
    private final String originalValue;
    private String newValue;
 
    public DayCommand(String oldVal, String newVal) {
    ...
    @Override
    public void execute() {
        Model.getInstance().setDay(newValue);
    }

    @Override
    public void undo() {
        Debug.info("undo " + className);
        Model.getInstance().setDay(originalValue);
    }
    ...
    public boolean update(Command newCommand) {
        ...
        DayCommand command = (DayCommand)newCommand;
